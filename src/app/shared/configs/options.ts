...
export const STREET_OPTIONS: OptionInterface[] = [
  { value: 'ST', label: 'street', disabled: false },
  { value: 'AVE', label: 'avenue', disabled: false },
  { value: 'PL', label: 'plaza', disabled: false },
  { value: 'SQ', label: 'square', disabled: false },
];
export const COUNTRY_OPTIONS: OptionInterface[] = [
...
export const US_STATES_OPTIONS: OptionInterface[] = [
  {
    label: 'Alabama',
    value: 'AL',
  },
...
export const FRANCE_PROVINCES_OPTIONS: OptionInterface[] = [
  {
    label: 'Alsace',
    value: 'FR-A',
  },
...
export const SPAIN_PROVINCE_OPTIONS: OptionInterface[] = [
  { label: 'A Coruña', value: 'ACO' },
  { label: 'Alava', value: 'ACO' },
  { label: 'Albacete', value: 'ACO' },
  { label: 'Almería', value: 'ACO' },
  { label: 'Ávila', value: 'ACO' },
  { label: 'Asturias', value: 'ACO' },
  { label: 'Badajoz', value: 'ACO' },
  { label: 'Barcelona', value: 'ACO' },
  { label: 'Baleares', value: 'ACO' },
  { label: 'Burgos', value: 'ACO' },
  { label: 'A Coruña', value: 'ACO' },
  { label: 'A Coruña', value: 'ACO' },
  { label: 'A Coruña', value: 'ACO' },
  { label: 'A Coruña', value: 'ACO' },
